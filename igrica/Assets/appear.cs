...
public class appear : MonoBehaviour
{
    ...
    int counter = 0;
    int numOfSeconds = 5; // How long is simulation going
    bool moving = true;
    ...
    void OnGUI()
    {
        if (showWindow)
        {
            ...
            windowRect = GUI.Window(0, windowRect, DoMyWindow, "Koji se sudare prvi? ",myWindowStyle);
